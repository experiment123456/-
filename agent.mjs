...
const tools = [
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          target: { type: "string", enum: ["home", "workbench", "dh", "network", "catalog", "innovation", "agent"] },
...
function sanitizeUiState(input) {
  const views = new Set(["home", "workbench", "dh", "network", "catalog", "innovation", "agent"]);
...
function mockResponse(messages) {
  ...
  return { text: "我是 Lumora AI 密码学导师。你可以让我讲解 AES、DH、SM2、MD5，也可以说“带我演示 AES”或“带我学习 DH”，我会直接打开对应页面并进行安全的站内演示。当前未配置千问 API Key，因此正在使用本地演示模式。" };
}
