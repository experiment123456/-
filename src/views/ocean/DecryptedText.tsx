// Vendored from React Bits (TS + Tailwind), adapted to drop the `motion` dependency
// (the original wraps a motion.span used only as an event container; a plain span works).
